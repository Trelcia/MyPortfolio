...
import { a as useRoute, E as Ee } from '../server.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const story = ([__temp, __restore] = withAsyncContext(() => Ee(`projects/${route.params.slug}`, {
      version: "draft"
...
//# sourceMappingURL=_slug_-b24a3a3e.mjs.map
